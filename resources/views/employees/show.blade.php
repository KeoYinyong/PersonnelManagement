        ...
        <div class="d-flex align-items-center justify-content-center p-5">
            <div style="width: 70%; height: 70%; border-radius: 25px;" class="shadow-lg p-3 mb-5 bg-body mt-5">
                <div style="text-align: center;">
                    <h2 style="color: goldenrod;">Employee Details</h2>
                </div>
                <div class="detail" style="border: solid 1px black; margin: 20px; padding: 20px;">
                    ...
                    <h4>=> Position Name : {{$position->title}}</h4>
                </div>
                <a href="{{ route('employees.index') }}" class="btn btn-outline-primary btn-lg">BACK</a>
