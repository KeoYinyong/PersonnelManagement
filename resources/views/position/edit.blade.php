        ...
        <div class="d-flex align-items-center justify-content-center p-5">
            <div style="width: 70%; height: 70%; border-radius: 25px;" class="shadow-lg p-3 mb-5 bg-body mt-5">
                <div style="text-align: center;">
                    <h2 style="color: goldenrod;">Update Position Name</h2>
                </div>
                <form style=" margin: 20px; padding: 20px;" action="{{ route('positions.update', $position->id) }}"
                    method="post">
                    @csrf
                    @method('PATCH')
                    <div class="mb-4">
                        ...
                        <input type="text" id="exampleFormControlInput1" name="title" class="form-control"
                            value="{{ $position->title }}" placeholder="Enter Position Name">
                    </div>
